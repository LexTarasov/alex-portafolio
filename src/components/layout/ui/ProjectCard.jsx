...
export default function ProjectCard({ icon: Icon, title, description, tech, githubUrl, liveUrl, featured }) {
  return (
    <div
    ...
    >
      ...
      <h3 className="flex items-center gap-2 text-lg font-medium text-white mb-2">
        {Icon && <Icon size={20} className="text-primary-400 shrink-0" aria-hidden="true" />}
        {title}
      </h3>
